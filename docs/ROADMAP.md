...
| | |
|---|---|
| **Current milestone** | **none open.** Next in the chain is **M-reflection-verdict**. The defect list is empty and what waits on the author is **panel 130**, one item: the sitting's verdict on the naming mandate they chose mid-sitting, at 7 of 7 against a cheaper reading's 2 of 7 |
...
| Waiting on the author | **1** decision, `panel 130`: the sitting's verdict on the naming mandate, the rule itself having been chosen by the author mid-sitting with both numbers in front of them · `panel 126` to `panel 129` ratified 2026-09-11 · **54** in `SCHEDULED.md` |
