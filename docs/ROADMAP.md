...
| The spec | **5945** on the vendored ranks and **7921** on the reader's own, against a ceiling of **10240** — raised from 8192 by author decision 2026-09-14, taken while the mark was landing and the document stood 211 free. `acquires <releaser>` and its balance clause are **+82 vendored and +115 real**, a ratio of 1.40 inside the band panel 148's warden predicted; **2319 free** and 2259 net of the FFI floor |
