...
| Records | sittings **109** · journals **34** · measurements **16** · examples **45** programs, 108 files, 505 `test` blocks · open defects **0** · the site **46** pages, 13 doc chapters per edition · all five numbers re-counted 2026-09-05, and four had drifted (sittings 106, journals 33, examples 44, defects 1) because nothing reads this row |
