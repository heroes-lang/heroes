...
| | |
|---|---|
| **Current milestone** | **none open.** Next in the chain is **M-reflection-verdict**. Before it, **defect 025**, filed 2026-09-11 by panel 126's own experiment, which is what leaves M-anchored-spec untagged: its repair is a panel's, either the label check reaching the built-in table or the document naming the exception |
...
| Waiting on the author | **0** decisions: `panel 126` ratified 2026-09-11, its conservative route recorded beside it and declined · **54** in `SCHEDULED.md` · **1** in `DEFECTS.md`, number 025, which is what leaves M-anchored-spec untagged · **353** in `LEARN.md` (never a gate) · an outstanding veto (`docs/panel/101` R3) · **o200k**, whose trigger is met and whose premise panel 123 changed |
...
One table, one row per milestone, **closed first and scheduled after**: rows 1–44
are done, in the order they closed, and rows 45–67 are what is next, in the order
