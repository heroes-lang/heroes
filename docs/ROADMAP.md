...
| | |
|---|---|
| **Current milestone** | **M-deferral-ledger**, opened 2026-09-13 on the trunk and at step 3: `alias` deferred with a date, doctests deferred with an expired clock struck, traits refused to Part 6 while the iteration wart was rewritten, variant constructors refused because every testable clause of their row was false, the `raw` module refused with Part 9 corrected beneath it, visibility refused with its undecidable count closed rather than passed on, and symmetric variants refused because nothing in the language destructures at all; **every Part 7 item the ledger owed now carries a dated verdict**, and Part 8's warts remain |
...
| Records | sittings **140** · journals **53** · milestone files **46** · entries: `docs/records/log/` **627**, `docs/records/done/` **494**, `docs/records/book/beats/` **118** · **open defects 3** (029, 030 and 031, all filed 2026-09-13 beside sittings and all one family: `ptr` carries neither a pointee type, nor identity, nor ownership) |
| Waiting on the author | **7** decisions: panels 136 to 142, in `docs/work/DECIDE.md`, one of which also asks for the one network call a spec amendment needs. Panel 135 was answered the night it sat, as 131 to 134 were |
