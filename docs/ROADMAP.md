...
| Records | sittings **138** · journals **53** · milestone files **46** · entries: `docs/records/log/` **627**, `docs/records/done/` **494**, `docs/records/book/beats/` **118** · **open defects 3** (029, 030 and 031, all filed 2026-09-13 beside sittings and all one family: `ptr` carries neither a pointee type, nor identity, nor ownership) |
| Waiting on the author | **5** decisions: panels 136 to 140, in `docs/work/DECIDE.md`, one of which also asks for the one network call a spec amendment needs. Panel 135 was answered the night it sat, as 131 to 134 were |
