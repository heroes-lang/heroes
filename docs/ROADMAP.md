...
| | |
|---|---|
| **Current milestone** | **M-deferral-ledger**, opened 2026-09-13 on the trunk and at step 3: `alias` deferred with a date, doctests deferred with an expired clock struck, traits refused to Part 6 while the iteration wart was rewritten, and variant constructors refused because every testable clause of their row was false; five of the nine remain, then Part 8's warts and coverage |
