...
| | |
|---|---|
| **Current milestone** | **M-deferral-ledger**, opened 2026-09-13 on the trunk and at step 3: `alias` deferred with a date, doctests deferred with an expired clock struck, and traits refused to Part 6 while the iteration wart was rewritten because its stated cause was false; six of the nine remain, then Part 8's warts and coverage |
