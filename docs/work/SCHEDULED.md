...
- [ ] **M-check-completeness** | the sortable obligation moves into the checker | `docs/panel/082` R3 · `selfhost/check/walk.hero` · `selfhost/check/ordering.hero`
...
- [ ] **M-check-completeness** | two rules that fire on a written type and not on an inferred one | `selfhost/check/map_keys.hero` · `selfhost/check/partial.hero` · `docs/panel/082` R3
...
- [ ] **M-core-packages** | §4.19 owes one sentence: a group's `#include` order is load-bearing | `design.md` §4.19 · `selfhost/emit/externs.hero:72` · `docs/panel/091`
...
- [ ] **M-core-packages** step 0 | a macro-only C function has no golden case, and the parenthesised probe breaks it | `selfhost/emit/extern_probe.hero:153` · `docs/panel/092` · `design.md` §4.19
...
- [ ] **M-core-packages** step 0 | three repairs before the first package, each a `fixedbugs` case | `selfhost/ir/place_store.hero:100` · `selfhost/cli/pointee.hero` · `docs/panel/092`, `103`
...
- [ ] **M-core-packages** | three repairs to design.md that ride its opening sitting | `design.md` §1.11, §3.5, §4.20, Part 7 item 4 · `docs/panel/056`
...
- [ ] **M-publication-gate** | no suite builds a gallery file, and nine of the twelve are named by no test | `examples/gallery/` · `tests/harness/suite_corpus.hero:44` · `examples/README.md`
