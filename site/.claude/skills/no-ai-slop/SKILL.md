---
name: no-ai-slop
description: Edit a draft to remove machine-written patterns, or audit one and name the patterns without rewriting. Use for any outward-facing text of this project: a site page, the README, release notes, a book chapter. Preserves the writer's voice; the em-dash rule here is absolute, because the site's is.
---

# No AI slop

**This was 92 lines inside `site/CLAUDE.md` until 2026-09-07.** It is a
procedure with two jobs, a workflow and a checklist, which is what a skill is,
...
**Em dashes.** Do not use them as a default rhythm crutch. In short copy, use none. In longer drafts, 1-2 are fine if they clearly beat commas, periods, or parentheses. Remove clusters and decorative dashes. **On this site the rule is absolute: none in prose** (author instruction 2026-08-25); verbatim compiler output and code copied from repository files keep whatever characters they actually contain.
...
4. For an edit, make the minimum effective changes, then check the edited draft against the rules in this file yourself.
