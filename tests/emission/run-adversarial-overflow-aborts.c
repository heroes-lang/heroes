/* Generated by heroes 0.0.1 from tests/golden/run/adversarial-overflow-aborts.hero. Do not edit. */
...
#line 43 "adversarialoverflowaborts.c"

typedef struct h_adversarialoverflowaborts_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_adversarialoverflowaborts_0opt0;

typedef struct h_adversarialoverflowaborts_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_adversarialoverflowaborts_0opt1;

void h_adversarialoverflowaborts_0opt0_retain(const h_adversarialoverflowaborts_0opt0 *v);
void h_adversarialoverflowaborts_0opt0_release(h_adversarialoverflowaborts_0opt0 *v);
bool h_adversarialoverflowaborts_0opt0_eq(const h_adversarialoverflowaborts_0opt0 *a, const h_adversarialoverflowaborts_0opt0 *b);
uint64_t h_adversarialoverflowaborts_0opt0_hash(const void *elem);
void h_adversarialoverflowaborts_0opt1_retain(const h_adversarialoverflowaborts_0opt1 *v);
void h_adversarialoverflowaborts_0opt1_release(h_adversarialoverflowaborts_0opt1 *v);
bool h_adversarialoverflowaborts_0opt1_eq(const h_adversarialoverflowaborts_0opt1 *a, const h_adversarialoverflowaborts_0opt1 *b);
uint64_t h_adversarialoverflowaborts_0opt1_hash(const void *elem);

void h_adversarialoverflowaborts_main(void);

#line 12 "tests/golden/run/adversarial-overflow-aborts.hero"
void h_adversarialoverflowaborts_main(void) {
#line 73 "adversarialoverflowaborts.c"
    int64_t h0_big;
    int64_t t1;
    int64_t t2;
    int64_t t3;
...
#line 13 "tests/golden/run/adversarial-overflow-aborts.hero"
    hero_print_end();
#line 14 "tests/golden/run/adversarial-overflow-aborts.hero"
    t2 = INT64_C(9223372036854775807);
#line 14 "tests/golden/run/adversarial-overflow-aborts.hero"
    h0_big = t2;
#line 15 "tests/golden/run/adversarial-overflow-aborts.hero"
    t3 = h0_big;
#line 15 "tests/golden/run/adversarial-overflow-aborts.hero"
    t4 = INT64_C(1);
#line 15 "tests/golden/run/adversarial-overflow-aborts.hero"
...
#line 16 "tests/golden/run/adversarial-overflow-aborts.hero"
    return;
#line 109 "adversarialoverflowaborts.c"
}
void h_adversarialoverflowaborts_0opt0_retain(const h_adversarialoverflowaborts_0opt0 *v) {
    if (v->tag == INT64_C(0)) {
...
uint64_t h_adversarialoverflowaborts_0opt0_hash(const void *elem) {
    const h_adversarialoverflowaborts_0opt0 *v = elem;
...
uint64_t h_adversarialoverflowaborts_0opt1_hash(const void *elem) {
    const h_adversarialoverflowaborts_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
...
int main(int argc, char **argv) {
    ...
    h_adversarialoverflowaborts_main();
