...
_Static_assert(HERO_RET_INT(sqlite3_openn(0, 0)), "heroes-ffi-return sqlite3_openn i64");
...
__attribute__((unused)) static void hero_ffi_probe_h_ffiunknownname_sqlite3_openn(const char * a0, void * * a1) { (void)(sqlite3_openn)(a0, (void *)a1); }
...
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    t3 = hero_str_cstr(t2);
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    t4 = sqlite3_openn(hero_cstr_nonnull(t3), (void *)&h0_db);
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    hero_print_int(t4);
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    hero_print_end();
