/* Generated by heroes 0.0.1 from tests/golden/fixedbugs/ffi-unknown-name.hero. Do not edit. */
...
_Static_assert(HERO_RET_INT(sqlite3_openn(0, (void * *)0)), "heroes-ffi-return sqlite3_openn i64");
...
#line 53 "ffiunknownname.c"

HERO_STR_STATIC(hero_str_0, ":memory:");

typedef struct h_ffiunknownname_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_ffiunknownname_0opt0;

typedef struct h_ffiunknownname_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_ffiunknownname_0opt1;

void h_ffiunknownname_0opt0_retain(const h_ffiunknownname_0opt0 *v);
void h_ffiunknownname_0opt0_release(h_ffiunknownname_0opt0 *v);
bool h_ffiunknownname_0opt0_eq(const h_ffiunknownname_0opt0 *a, const h_ffiunknownname_0opt0 *b);
uint64_t h_ffiunknownname_0opt0_hash(const void *elem);
void h_ffiunknownname_0opt1_retain(const h_ffiunknownname_0opt1 *v);
void h_ffiunknownname_0opt1_release(h_ffiunknownname_0opt1 *v);
bool h_ffiunknownname_0opt1_eq(const h_ffiunknownname_0opt1 *a, const h_ffiunknownname_0opt1 *b);
uint64_t h_ffiunknownname_0opt1_hash(const void *elem);

void h_ffiunknownname_main(void);

#line 33 "tests/golden/fixedbugs/ffi-unknown-name.hero"
void h_ffiunknownname_main(void) {
#line 85 "ffiunknownname.c"
...
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    t3 = hero_str_cstr(t2);
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    t4 = sqlite3_openn(hero_cstr_nonnull(t3), &h0_db);
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    hero_print_int(t4);
#line 35 "tests/golden/fixedbugs/ffi-unknown-name.hero"
    hero_print_end();
...
uint64_t h_ffiunknownname_0opt0_hash(const void *elem) {
    const h_ffiunknownname_0opt0 *v = elem;
...
uint64_t h_ffiunknownname_0opt1_hash(const void *elem) {
    const h_ffiunknownname_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
