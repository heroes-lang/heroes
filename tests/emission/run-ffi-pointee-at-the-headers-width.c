/* Generated by heroes 0.0.1 from tests/golden/run/ffi-pointee-at-the-headers-width.hero. Do not edit. */
...
_Static_assert(HERO_RET_INT(time(0)), "heroes-ffi-return time i64");
...
#line 48 "ffipointeeattheheaderswidth.c"
...
#line 11 "tests/golden/run/ffi-pointee-at-the-headers-width.hero"
__attribute__((unused)) static void hero_ffi_probe_h_ffipointeeattheheaderswidth_frexp(double a0, int32_t * a1) { (void)(frexp)(a0, (void *)a1); }
#line 14 "tests/golden/run/ffi-pointee-at-the-headers-width.hero"
...
#line 85 "ffipointeeattheheaderswidth.c"
...
void h_ffipointeeattheheaderswidth_main(void) {
#line 101 "ffipointeeattheheaderswidth.c"
    int32_t h0_e;
    double h1_m;
    int64_t h2_t;
    int32_t t1;
...
#line 23 "tests/golden/run/ffi-pointee-at-the-headers-width.hero"
    return;
#line 156 "ffipointeeattheheaderswidth.c"
}
HERO_TU_LOCAL void h_0opt_f87774a_retain(const h_0opt_f87774a *v) {
    if (v->tag == INT64_C(0)) {
...
int main(int argc, char **argv) {
    ...
    h_ffipointeeattheheaderswidth_main();
