/* Generated by heroes 0.2.0 from tests/golden/run/c-frees-a-lease-through-a-callback.hero. Do not edit. */
...
_Static_assert(HERO_RET_UNIT(take_cb(0, (void *)0)), "heroes-ffi-return take_cb ()");
...
#line 50 "cfreesaleasethroughacallback.c"
...
int main(int argc, char **argv) {
    ...
    h_cfreesaleasethroughacallback_main();
