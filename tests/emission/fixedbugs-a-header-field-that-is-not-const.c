/* Generated by heroes 0.2.0 from tests/golden/fixedbugs/a-header-field-that-is-not-const.hero. Do not edit. */
...
HERO_TU_LOCAL uint64_t h_aheaderfieldthatisnotconst_Passwd_hash(const void *elem);
...
HERO_TU_LOCAL uint64_t h_aheaderfieldthatisnotconst_Passwd_hash(const void *elem) {
    (void)elem; hero_panic("h_aheaderfieldthatisnotconst_Passwd_hash: a partial record has no structural hash");
}
...
int main(int argc, char **argv) {
    ...
    h_aheaderfieldthatisnotconst_main();
