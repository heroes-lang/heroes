/* Generated by heroes 0.0.1 from tests/golden/run/abort-nan-in-an-ordering.hero. Do not edit. */
...
#line 41 "abortnaninanordering.c"
...
#line 59 "abortnaninanordering.c"
#pragma clang diagnostic pop

typedef struct h_abortnaninanordering_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_abortnaninanordering_0opt0;

typedef struct h_abortnaninanordering_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_abortnaninanordering_0opt1;

void h_abortnaninanordering_0opt0_retain(const h_abortnaninanordering_0opt0 *v);
void h_abortnaninanordering_0opt0_release(h_abortnaninanordering_0opt0 *v);
bool h_abortnaninanordering_0opt0_eq(const h_abortnaninanordering_0opt0 *a, const h_abortnaninanordering_0opt0 *b);
uint64_t h_abortnaninanordering_0opt0_hash(const void *elem);
void h_abortnaninanordering_0opt1_retain(const h_abortnaninanordering_0opt1 *v);
void h_abortnaninanordering_0opt1_release(h_abortnaninanordering_0opt1 *v);
bool h_abortnaninanordering_0opt1_eq(const h_abortnaninanordering_0opt1 *a, const h_abortnaninanordering_0opt1 *b);
uint64_t h_abortnaninanordering_0opt1_hash(const void *elem);

void h_abortnaninanordering_main(void);

#line 43 "tests/golden/run/abort-nan-in-an-ordering.hero"
void h_abortnaninanordering_main(void) {
#line 90 "abortnaninanordering.c"
    double h0_zero;
    double h1_n;
    double t1;
    double t2;
...
#line 49 "tests/golden/run/abort-nan-in-an-ordering.hero"
    t15 = 0x1p+0;
#line 49 "tests/golden/run/abort-nan-in-an-ordering.hero"
    if (t14 != t14 || t15 != t15) hero_panic("a nan in `<`: it is neither less nor greater, so both arms would be false");
#line 49 "tests/golden/run/abort-nan-in-an-ordering.hero"
    t16 = t14 < t15;
#line 49 "tests/golden/run/abort-nan-in-an-ordering.hero"
    hero_print_bool(t16);
...
#line 49 "tests/golden/run/abort-nan-in-an-ordering.hero"
    return;
#line 169 "abortnaninanordering.c"
}
void h_abortnaninanordering_0opt0_retain(const h_abortnaninanordering_0opt0 *v) {
    if (v->tag == INT64_C(0)) {
...
uint64_t h_abortnaninanordering_0opt0_hash(const void *elem) {
    const h_abortnaninanordering_0opt0 *v = elem;
...
uint64_t h_abortnaninanordering_0opt1_hash(const void *elem) {
    const h_abortnaninanordering_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
