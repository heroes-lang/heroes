/* Generated by heroes 0.2.0 from tests/golden/fixedbugs/ffi-callback-const-pointee.hero. Do not edit. */
...
_Static_assert(HERO_RET_UNIT(qsort((void *)0, (uint64_t)0, (uint64_t)0, (void *)0)), "heroes-ffi-return qsort ()");
...
#line 83 "fficallbackconstpointee.c"
...
int main(int argc, char **argv) {
    ...
    h_fficallbackconstpointee_main();
