/* Generated by heroes 0.1.0 from tests/golden/fixedbugs/ffi-call-arity.hero. Do not edit. */
...
_Static_assert(HERO_RET_CSTR(strtok(0, 0, 0)), "heroes-ffi-return strtok cstr");
...
HERO_STR_STATIC(hero_str_197d4f, "a,b");
HERO_STR_STATIC(hero_str_2c, ",");
HERO_STR_STATIC(hero_str_0, "");

#line 51 "fficallarity.c"
...
#line 21 "tests/golden/fixedbugs/ffi-call-arity.hero"
__attribute__((unused)) static void hero_ffi_probe_h_fficallarity_strtok(const char * a0, const char * a1, const char * a2) { (void)(strtok)(a0, a1, a2); }
...
void h_fficallarity_main(void);

#line 23 "tests/golden/fixedbugs/ffi-call-arity.hero"
void h_fficallarity_main(void) {
#line 102 "fficallarity.c"
    HeroStr t1 = {0};
    const char * t2;
    HeroStr t3 = {0};
    const char * t4;
    ...
    goto bb0;
bb0:
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t1 = HERO_STR_LIT(hero_str_197d4f);
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t2 = hero_str_cstr(t1);
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t3 = HERO_STR_LIT(hero_str_2c);
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t4 = hero_str_cstr(t3);
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
...
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t6 = hero_str_cstr(t5);
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t7 = (const char *)strtok(hero_cstr_nonnull(t2), hero_cstr_nonnull(t4), hero_cstr_nonnull(t6));
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t8 = ((void *)0);
#line 24 "tests/golden/fixedbugs/ffi-call-arity.hero"
    t9 = t7 == t8;
