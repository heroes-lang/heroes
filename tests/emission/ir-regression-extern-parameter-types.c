...
#line 48 "regressionexternparametertypes.c"
...
#line 70 "regressionexternparametertypes.c"
...
double h_regressionexternparametertypes_hypotenuse(double h0_a, double h1_b) {
#line 102 "regressionexternparametertypes.c"
    double t1;
    double t2;
    double t3;
    double t4;
...
#line 17 "tests/golden/ir/regression-extern-parameter-types.hero"
    return t8;
#line 131 "regressionexternparametertypes.c"
}

#line 19 "tests/golden/ir/regression-extern-parameter-types.hero"
int64_t h_regressionexternparametertypes_distance(int64_t h0_a, int64_t h1_b) {
#line 136 "regressionexternparametertypes.c"
    int64_t t1;
    int64_t t2;
    int64_t t3;
    int64_t t4;
...
#line 20 "tests/golden/ir/regression-extern-parameter-types.hero"
    return t4;
#line 153 "regressionexternparametertypes.c"
}
HERO_TU_LOCAL void h_0opt_f87774a_retain(const h_0opt_f87774a *v) {
    if (v->tag == INT64_C(0)) {
