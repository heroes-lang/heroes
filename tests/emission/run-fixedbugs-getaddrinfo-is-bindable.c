/* Generated by heroes 0.2.0 from tests/golden/run/fixedbugs-getaddrinfo-is-bindable.hero. Do not edit. */
...
#line 50 "fixedbugsgetaddrinfoisbindable.c"
...
int main(int argc, char **argv) {
    ...
    h_fixedbugsgetaddrinfoisbindable_main();
