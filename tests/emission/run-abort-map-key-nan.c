...
#line 25 "tests/golden/run/abort-map-key-nan.hero"
    return t3;
#line 111 "abortmapkeynan.c"
}

#line 33 "tests/golden/run/abort-map-key-nan.hero"
void h_abortmapkeynan_main(void) {
#line 116 "abortmapkeynan.c"
