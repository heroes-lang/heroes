/* Generated by heroes 0.2.0 from tests/golden/run/abort-handle-given-back-unmarked.hero. Do not edit. */
#include "heroes_runtime.h"
#include <math.h>
#include <hero_os.h>
#include <abort-handle-given-back-unmarked.h>
#include <heroes_runtime.h>
...
_Static_assert(HERO_RET_RECORD(slot_open((int64_t)0), Slot *), "heroes-ffi-return slot_open Slot");
...
#line 50 "aborthandlegivenbackunmarked.c"
...
#line 18 "tests/golden/run/abort-handle-given-back-unmarked.hero"
__attribute__((unused)) static void hero_ffi_probe_h_aborthandlegivenbackunmarked_slot_open(int64_t a0) { (void)(slot_open)(a0); }
#line 19 "tests/golden/run/abort-handle-given-back-unmarked.hero"
__attribute__((unused)) static void hero_ffi_probe_h_aborthandlegivenbackunmarked_slot_close(Slot * a0) { (void)(slot_close)(a0); }
#line 20 "tests/golden/run/abort-handle-given-back-unmarked.hero"
__attribute__((unused)) static void hero_ffi_probe_h_aborthandlegivenbackunmarked_slot_value(Slot * a0) { (void)(slot_value)(a0); }
...
#line 89 "aborthandlegivenbackunmarked.c"
#pragma clang diagnostic pop

HERO_TU_LOCAL bool h_aborthandlegivenbackunmarked_Slot_eq(Slot * const *a, Slot * const *b);
HERO_TU_LOCAL uint64_t h_aborthandlegivenbackunmarked_Slot_hash(const void *elem);
...
void h_aborthandlegivenbackunmarked_main(void);

#line 22 "tests/golden/run/abort-handle-given-back-unmarked.hero"
void h_aborthandlegivenbackunmarked_main(void) {
#line 107 "aborthandlegivenbackunmarked.c"
    Slot * h0_a;
    int64_t t1;
    Slot * t2;
    Slot * t3;
    ...
    goto bb0;
bb0:
#line 23 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    t1 = INT64_C(7);
#line 23 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    t2 = slot_open(t1);
#line 23 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    h0_a = t2;
#line 24 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    t3 = h0_a;
#line 24 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    t4 = slot_value(t3);
#line 24 "tests/golden/run/abort-handle-given-back-unmarked.hero"
...
#line 24 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    hero_print_end();
#line 25 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    t5 = h0_a;
#line 25 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    (void)slot_close(t5);
#line 25 "tests/golden/run/abort-handle-given-back-unmarked.hero"
...
#line 25 "tests/golden/run/abort-handle-given-back-unmarked.hero"
    return;
#line 138 "aborthandlegivenbackunmarked.c"
}
HERO_TU_LOCAL bool h_aborthandlegivenbackunmarked_Slot_eq(Slot * const *a, Slot * const *b) {
    return *a == *b;
}
...
int main(int argc, char **argv) {
    ...
    h_aborthandlegivenbackunmarked_main();
