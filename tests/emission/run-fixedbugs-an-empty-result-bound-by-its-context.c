/* Generated by heroes 0.0.1 from tests/golden/run/fixedbugs-an-empty-result-bound-by-its-context.hero. Do not edit. */
...
#line 45 "fixedbugsanemptyresultboundbyitscontext.c"
...
#line 63 "fixedbugsanemptyresultboundbyitscontext.c"
