/* Generated by heroes 0.0.1 from tests/golden/run/ffi-libm.hero. Do not edit. */
...
typedef struct h_ffilibm_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
...
void h_ffilibm_0opt0_release(h_ffilibm_0opt0 *v);
bool h_ffilibm_0opt0_eq(const h_ffilibm_0opt0 *a, const h_ffilibm_0opt0 *b);
uint64_t h_ffilibm_0opt0_hash(const void *elem);
void h_ffilibm_0opt1_retain(const h_ffilibm_0opt1 *v);
void h_ffilibm_0opt1_release(h_ffilibm_0opt1 *v);
bool h_ffilibm_0opt1_eq(const h_ffilibm_0opt1 *a, const h_ffilibm_0opt1 *b);
uint64_t h_ffilibm_0opt1_hash(const void *elem);
