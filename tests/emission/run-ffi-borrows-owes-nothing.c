/* Generated by heroes 0.2.0 from tests/golden/run/ffi-borrows-owes-nothing.hero. Do not edit. */
...
_Static_assert(HERO_RET_RECORD(slot_peek(), Slot *), "heroes-ffi-return slot_peek Slot");
...
HERO_STR_STATIC(hero_str_2f69e1a4, "the borrowed one was not given back");

#line 53 "ffiborrowsowesnothing.c"
...
#line 19 "tests/golden/run/ffi-borrows-owes-nothing.hero"
