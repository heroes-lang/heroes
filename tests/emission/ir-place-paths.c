/* Generated by heroes 0.0.1 from tests/golden/ir/place-paths.hero. Do not edit. */
...
typedef struct h_placepaths_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
...
typedef struct h_placepaths_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
...
void h_placepaths_Row_release(h_placepaths_Row *v);
bool h_placepaths_Row_eq(const h_placepaths_Row *a, const h_placepaths_Row *b);
uint64_t h_placepaths_Row_hash(const void *elem);
void h_placepaths_Grid_retain(const h_placepaths_Grid *v);
void h_placepaths_Grid_release(h_placepaths_Grid *v);
bool h_placepaths_Grid_eq(const h_placepaths_Grid *a, const h_placepaths_Grid *b);
uint64_t h_placepaths_Grid_hash(const void *elem);
void h_placepaths_0opt0_retain(const h_placepaths_0opt0 *v);
void h_placepaths_0opt0_release(h_placepaths_0opt0 *v);
bool h_placepaths_0opt0_eq(const h_placepaths_0opt0 *a, const h_placepaths_0opt0 *b);
uint64_t h_placepaths_0opt0_hash(const void *elem);
void h_placepaths_0opt1_retain(const h_placepaths_0opt1 *v);
void h_placepaths_0opt1_release(h_placepaths_0opt1 *v);
...
uint64_t h_placepaths_0opt0_hash(const void *elem) {
    const h_placepaths_0opt0 *v = elem;
...
uint64_t h_placepaths_0opt1_hash(const void *elem) {
    const h_placepaths_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
