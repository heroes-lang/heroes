/* Generated by heroes 0.0.1 from tests/golden/ir/sugar-test-assert.hero. Do not edit. */
...
} h_sugartestassert_0opt0;

typedef struct h_sugartestassert_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_sugartestassert_0opt1;

void h_sugartestassert_0opt0_retain(const h_sugartestassert_0opt0 *v);
void h_sugartestassert_0opt0_release(h_sugartestassert_0opt0 *v);
bool h_sugartestassert_0opt0_eq(const h_sugartestassert_0opt0 *a, const h_sugartestassert_0opt0 *b);
uint64_t h_sugartestassert_0opt0_hash(const void *elem);
void h_sugartestassert_0opt1_retain(const h_sugartestassert_0opt1 *v);
void h_sugartestassert_0opt1_release(h_sugartestassert_0opt1 *v);
bool h_sugartestassert_0opt1_eq(const h_sugartestassert_0opt1 *a, const h_sugartestassert_0opt1 *b);
uint64_t h_sugartestassert_0opt1_hash(const void *elem);

int64_t h_sugartestassert_add(int64_t h0_a, int64_t h1_b);

#line 6 "tests/golden/ir/sugar-test-assert.hero"
int64_t h_sugartestassert_add(int64_t h0_a, int64_t h1_b) {
#line 73 "sugartestassert.c"
    int64_t t1;
    int64_t t2;
    int64_t t3;
    goto bb0;
...
uint64_t h_sugartestassert_0opt0_hash(const void *elem) {
    const h_sugartestassert_0opt0 *v = elem;
...
uint64_t h_sugartestassert_0opt1_hash(const void *elem) {
    const h_sugartestassert_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
