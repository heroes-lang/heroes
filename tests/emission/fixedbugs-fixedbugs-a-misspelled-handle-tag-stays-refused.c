/* Generated by heroes 0.2.0 from tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero. Do not edit. */
...
_Static_assert(HERO_RET_UNIT(freeaddrinfo((addrinfoo *){0})), "heroes-ffi-return freeaddrinfo ()");
...
#line 47 "fixedbugsamisspelledhandletagstaysrefused.c"
...
#line 19 "tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero"
__attribute__((unused)) static void hero_ffi_probe_h_fixedbugsamisspelledhandletagstaysrefused_freeaddrinfo(addrinfoo * a0) { (void)(freeaddrinfo)(a0); }
...
#line 82 "fixedbugsamisspelledhandletagstaysrefused.c"
#pragma clang diagnostic pop

HERO_TU_LOCAL bool h_fixedbugsamisspelledhandletagstaysrefused_AI_eq(addrinfoo * const *a, addrinfoo * const *b);
HERO_TU_LOCAL uint64_t h_fixedbugsamisspelledhandletagstaysrefused_AI_hash(const void *elem);
...
void h_fixedbugsamisspelledhandletagstaysrefused_main(void);

#line 21 "tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero"
void h_fixedbugsamisspelledhandletagstaysrefused_main(void) {
#line 100 "fixedbugsamisspelledhandletagstaysrefused.c"
    int64_t t1;
    goto bb0;
bb0:
#line 22 "tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero"
    t1 = INT64_C(0);
#line 22 "tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero"
    hero_print_int(t1);
#line 22 "tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero"
...
#line 22 "tests/golden/fixedbugs/fixedbugs-a-misspelled-handle-tag-stays-refused.hero"
    return;
#line 112 "fixedbugsamisspelledhandletagstaysrefused.c"
}
HERO_TU_LOCAL bool h_fixedbugsamisspelledhandletagstaysrefused_AI_eq(addrinfoo * const *a, addrinfoo * const *b) {
    return *a == *b;
}
...
int main(int argc, char **argv) {
    ...
    h_fixedbugsamisspelledhandletagstaysrefused_main();
