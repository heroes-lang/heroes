/* Generated by heroes 0.2.0 from tests/golden/run/fixedbugs-a-real-deallocator-given-the-same-handle-twice.hero. Do not edit. */
...
_Static_assert(HERO_RET_RECORD(blk_open((int64_t)0), blk *), "heroes-ffi-return blk_open Blk");
_Static_assert(HERO_RET_UNIT(blk_close((blk *){0})), "heroes-ffi-return blk_close ()");
_Static_assert(HERO_RET_INT(blk_value((blk *){0})), "heroes-ffi-return blk_value i64");
...
HERO_TU_LOCAL uint64_t h_fixedbugsarealdeallocatorgiventhesamehandletwice_Blk_hash(const void *elem);
...
int main(int argc, char **argv) {
    ...
    h_fixedbugsarealdeallocatorgiventhesamehandletwice_main();
