/* Generated by heroes 0.2.0 from tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero. Do not edit. */
...
#line 28 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
_Static_assert(__builtin_classify_type(((struct sqlite3 *)0)->nBtree) == 1 && sizeof(((struct sqlite3 *)0)->nBtree) == sizeof(int32_t) && (_Generic(((struct sqlite3 *)0)->nBtree, unsigned char:1, unsigned short:1, unsigned int:1, unsigned long:1, unsigned long long:1, _Bool:1, char:((char)-1 > 0), signed char:0, short:0, int:0, long:0, long long:0, default:0) == 0), "heroes-ffi-field DbValue nBtree");
#line 15 "fixedbugsatagwithtwokindsnamestherightrecord.c"
...
#line 29 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
__attribute__((unused)) static void hero_ffi_probe_h_fixedbugsatagwithtwokindsnamestherightrecord_sqlite3_close(sqlite3 * a0) { (void)(sqlite3_close)(a0); }
...
#line 85 "fixedbugsatagwithtwokindsnamestherightrecord.c"
#pragma clang diagnostic pop

HERO_TU_LOCAL bool h_fixedbugsatagwithtwokindsnamestherightrecord_Db_eq(sqlite3 * const *a, sqlite3 * const *b);
HERO_TU_LOCAL uint64_t h_fixedbugsatagwithtwokindsnamestherightrecord_Db_hash(const void *elem);
HERO_TU_LOCAL bool h_fixedbugsatagwithtwokindsnamestherightrecord_DbValue_eq(const struct sqlite3 *a, const struct sqlite3 *b);
HERO_TU_LOCAL uint64_t h_fixedbugsatagwithtwokindsnamestherightrecord_DbValue_hash(const void *elem);
...
void h_fixedbugsatagwithtwokindsnamestherightrecord_main(void);

#line 31 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
void h_fixedbugsatagwithtwokindsnamestherightrecord_main(void) {
#line 105 "fixedbugsatagwithtwokindsnamestherightrecord.c"
    int64_t t1;
    goto bb0;
bb0:
#line 32 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
    t1 = INT64_C(0);
#line 32 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
    hero_print_int(t1);
#line 32 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
...
#line 32 "tests/golden/fixedbugs/fixedbugs-a-tag-with-two-kinds-names-the-right-record.hero"
    return;
#line 117 "fixedbugsatagwithtwokindsnamestherightrecord.c"
}
HERO_TU_LOCAL bool h_fixedbugsatagwithtwokindsnamestherightrecord_Db_eq(sqlite3 * const *a, sqlite3 * const *b) {
    return *a == *b;
}
...
HERO_TU_LOCAL bool h_fixedbugsatagwithtwokindsnamestherightrecord_DbValue_eq(const struct sqlite3 *a, const struct sqlite3 *b) {
    hero_panic("h_fixedbugsatagwithtwokindsnamestherightrecord_DbValue_eq: a partial record has no structural equality");
}

HERO_TU_LOCAL uint64_t h_fixedbugsatagwithtwokindsnamestherightrecord_DbValue_hash(const void *elem) {
    (void)elem; hero_panic("h_fixedbugsatagwithtwokindsnamestherightrecord_DbValue_hash: a partial record has no structural hash");
}
...
int main(int argc, char **argv) {
    ...
    h_fixedbugsatagwithtwokindsnamestherightrecord_main();
