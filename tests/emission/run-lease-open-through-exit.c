/* Generated by heroes 0.2.0 from tests/golden/run/lease-open-through-exit.hero. Do not edit. */
...
#line 49 "leaseopenthroughexit.c"
...
#line 32 "tests/golden/run/lease-open-through-exit.hero"
__attribute__((unused)) static void hero_ffi_probe_h_leaseopenthroughexit_strlen(const char * a0) { (void)(strlen)(a0); }
...
#line 84 "leaseopenthroughexit.c"
...
void h_leaseopenthroughexit_main(void);
void h_library_exit(int64_t h0_code);

#line 34 "tests/golden/run/lease-open-through-exit.hero"
void h_leaseopenthroughexit_main(void) {
#line 101 "leaseopenthroughexit.c"
    const char * h0_c;
    HeroStr t1 = {0};
    const char * t2;
    const char * t3;
    ...
    goto bb0;
bb0:
#line 35 "tests/golden/run/lease-open-through-exit.hero"
    t1 = HERO_STR_LIT(hero_str_642cda73);
#line 35 "tests/golden/run/lease-open-through-exit.hero"
    t2 = hero_str_held(t1);
#line 35 "tests/golden/run/lease-open-through-exit.hero"
    h0_c = t2;
#line 36 "tests/golden/run/lease-open-through-exit.hero"
    t3 = h0_c;
#line 36 "tests/golden/run/lease-open-through-exit.hero"
...
#line 36 "tests/golden/run/lease-open-through-exit.hero"
    hero_print_end();
#line 37 "tests/golden/run/lease-open-through-exit.hero"
    t5 = INT64_C(0);
#line 37 "tests/golden/run/lease-open-through-exit.hero"
    h_library_exit(t5);
#line 37 "tests/golden/run/lease-open-through-exit.hero"
    return;
#line 130 "leaseopenthroughexit.c"
}

#line 219 "<heroes library>"
void h_library_exit(int64_t h0_code) {
#line 135 "leaseopenthroughexit.c"
    int64_t t1;
    goto bb0;
bb0:
...
#line 220 "<heroes library>"
    return;
#line 145 "leaseopenthroughexit.c"
}
HERO_TU_LOCAL void h_0opt_f87774a_retain(const h_0opt_f87774a *v) {
    if (v->tag == INT64_C(0)) {
