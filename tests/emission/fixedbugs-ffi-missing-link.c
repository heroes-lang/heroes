/* Generated by heroes 0.0.1 from tests/golden/fixedbugs/ffi-missing-link.hero. Do not edit. */
...
_Static_assert(HERO_RET_INT(sqlite3_libversion_number()), "heroes-ffi-return sqlite3_libversion_number i64");
...
#line 45 "ffimissinglink.c"

HERO_STR_STATIC(hero_str_0, "sqlite ");

typedef struct h_ffimissinglink_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_ffimissinglink_0opt0;

typedef struct h_ffimissinglink_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_ffimissinglink_0opt1;

void h_ffimissinglink_0opt0_retain(const h_ffimissinglink_0opt0 *v);
void h_ffimissinglink_0opt0_release(h_ffimissinglink_0opt0 *v);
bool h_ffimissinglink_0opt0_eq(const h_ffimissinglink_0opt0 *a, const h_ffimissinglink_0opt0 *b);
uint64_t h_ffimissinglink_0opt0_hash(const void *elem);
void h_ffimissinglink_0opt1_retain(const h_ffimissinglink_0opt1 *v);
void h_ffimissinglink_0opt1_release(h_ffimissinglink_0opt1 *v);
bool h_ffimissinglink_0opt1_eq(const h_ffimissinglink_0opt1 *a, const h_ffimissinglink_0opt1 *b);
uint64_t h_ffimissinglink_0opt1_hash(const void *elem);

void h_ffimissinglink_main(void);

#line 59 "tests/golden/fixedbugs/ffi-missing-link.hero"
void h_ffimissinglink_main(void) {
#line 77 "ffimissinglink.c"
    HeroStr t1 = {0};
    int64_t t2;
    goto bb0;
bb0:
...
uint64_t h_ffimissinglink_0opt0_hash(const void *elem) {
    const h_ffimissinglink_0opt0 *v = elem;
...
uint64_t h_ffimissinglink_0opt1_hash(const void *elem) {
    const h_ffimissinglink_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
