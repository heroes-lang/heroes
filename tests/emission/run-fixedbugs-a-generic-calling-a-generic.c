...
HERO_TU_LOCAL uint64_t h_fixedbugsagenericcallingageneric_P_hash(const void *elem);
...
HERO_TU_QUIET static const HeroDesc h_fixedbugsagenericcallingageneric_P_desc = {
