...
typedef struct h_recordsownstrings_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_recordsownstrings_0opt0;

typedef struct h_recordsownstrings_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_recordsownstrings_0opt1;
...
void h_recordsownstrings_0opt0_retain(const h_recordsownstrings_0opt0 *v);
void h_recordsownstrings_0opt0_release(h_recordsownstrings_0opt0 *v);
bool h_recordsownstrings_0opt0_eq(const h_recordsownstrings_0opt0 *a, const h_recordsownstrings_0opt0 *b);
uint64_t h_recordsownstrings_0opt0_hash(const void *elem);
void h_recordsownstrings_0opt1_retain(const h_recordsownstrings_0opt1 *v);
void h_recordsownstrings_0opt1_release(h_recordsownstrings_0opt1 *v);
bool h_recordsownstrings_0opt1_eq(const h_recordsownstrings_0opt1 *a, const h_recordsownstrings_0opt1 *b);
uint64_t h_recordsownstrings_0opt1_hash(const void *elem);
...
#line 25 "tests/golden/run/records-own-strings.hero"
    h1_own1 = t4;
#line 119 "recordsownstrings.c"
    hero_str_decref(t5);
#line 25 "tests/golden/run/records-own-strings.hero"
#line 122 "recordsownstrings.c"
    hero_str_incref(t4);
#line 25 "tests/golden/run/records-own-strings.hero"
    t6 = h1_own1;
#line 126 "recordsownstrings.c"
    hero_str_decref(t6);
    return t4;
}
...
#line 133 "recordsownstrings.c"
    ...
    h_recordsownstrings_Person t51 = {0};
    h_recordsownstrings_Person t52 = {0};
    h_recordsownstrings_Pair t53 = {0};
    HeroStr t54 = {0};
    h_recordsownstrings_Person t55 = {0};
    HeroStr t56 = {0};
    h_recordsownstrings_Person t57 = {0};
    h_recordsownstrings_Pair t58 = {0};
    h_recordsownstrings_Pair t59 = {0};
    goto bb0;
bb0:
...
#line 30 "tests/golden/run/records-own-strings.hero"
    h3_own3 = t3;
#line 214 "recordsownstrings.c"
    hero_str_decref(t40);
#line 30 "tests/golden/run/records-own-strings.hero"
    t4 = INT64_C(36);
#line 218 "recordsownstrings.c"
    hero_str_incref(t3);
#line 30 "tests/golden/run/records-own-strings.hero"
...
#line 36 "tests/golden/run/records-own-strings.hero"
    t19 = h1_q;
#line 308 "recordsownstrings.c"
    h_recordsownstrings_Person_retain(&t18);
#line 36 "tests/golden/run/records-own-strings.hero"
#line 311 "recordsownstrings.c"
...
#line 38 "tests/golden/run/records-own-strings.hero"
    t29 = h1_q;
#line 353 "recordsownstrings.c"
    h_recordsownstrings_Person_retain(&t28);
#line 38 "tests/golden/run/records-own-strings.hero"
#line 356 "recordsownstrings.c"
...
uint64_t h_recordsownstrings_0opt0_hash(const void *elem) {
    const h_recordsownstrings_0opt0 *v = elem;
...
uint64_t h_recordsownstrings_0opt1_hash(const void *elem) {
    const h_recordsownstrings_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
