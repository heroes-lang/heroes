...
typedef struct h_fficonstant_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
...
void h_fficonstant_0opt0_release(h_fficonstant_0opt0 *v);
bool h_fficonstant_0opt0_eq(const h_fficonstant_0opt0 *a, const h_fficonstant_0opt0 *b);
uint64_t h_fficonstant_0opt0_hash(const void *elem);
void h_fficonstant_0opt1_retain(const h_fficonstant_0opt1 *v);
void h_fficonstant_0opt1_release(h_fficonstant_0opt1 *v);
bool h_fficonstant_0opt1_eq(const h_fficonstant_0opt1 *a, const h_fficonstant_0opt1 *b);
uint64_t h_fficonstant_0opt1_hash(const void *elem);
...
uint64_t h_fficonstant_0opt0_hash(const void *elem) {
    const h_fficonstant_0opt0 *v = elem;
...
uint64_t h_fficonstant_0opt1_hash(const void *elem) {
    const h_fficonstant_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
