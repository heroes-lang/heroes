/* Generated by heroes 0.0.1 from tests/golden/run/abort-repeat-overflows.hero. Do not edit. */
...
#line 43 "abortrepeatoverflows.c"

HERO_STR_STATIC(hero_str_0, "before");
HERO_STR_STATIC(hero_str_1, "abcd");
HERO_STR_STATIC(hero_str_2, "unreachable");

typedef struct h_abortrepeatoverflows_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_abortrepeatoverflows_0opt0;

typedef struct h_abortrepeatoverflows_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_abortrepeatoverflows_0opt1;

void h_abortrepeatoverflows_0opt0_retain(const h_abortrepeatoverflows_0opt0 *v);
void h_abortrepeatoverflows_0opt0_release(h_abortrepeatoverflows_0opt0 *v);
bool h_abortrepeatoverflows_0opt0_eq(const h_abortrepeatoverflows_0opt0 *a, const h_abortrepeatoverflows_0opt0 *b);
uint64_t h_abortrepeatoverflows_0opt0_hash(const void *elem);
void h_abortrepeatoverflows_0opt1_retain(const h_abortrepeatoverflows_0opt1 *v);
void h_abortrepeatoverflows_0opt1_release(h_abortrepeatoverflows_0opt1 *v);
bool h_abortrepeatoverflows_0opt1_eq(const h_abortrepeatoverflows_0opt1 *a, const h_abortrepeatoverflows_0opt1 *b);
uint64_t h_abortrepeatoverflows_0opt1_hash(const void *elem);

void h_abortrepeatoverflows_main(void);

#line 21 "tests/golden/run/abort-repeat-overflows.hero"
void h_abortrepeatoverflows_main(void) {
#line 77 "abortrepeatoverflows.c"
    uint64_t h0_n;
    HeroStr h1_own1 = {0};
    HeroStr t1 = {0};
    uint64_t t2;
...
#line 25 "tests/golden/run/abort-repeat-overflows.hero"
    h1_own1 = t5;
#line 111 "abortrepeatoverflows.c"
    hero_str_decref(t8);
#line 25 "tests/golden/run/abort-repeat-overflows.hero"
    t6 = hero_str_len(t5);
#line 25 "tests/golden/run/abort-repeat-overflows.hero"
...
#line 26 "tests/golden/run/abort-repeat-overflows.hero"
    t9 = h1_own1;
#line 127 "abortrepeatoverflows.c"
    hero_str_decref(t9);
    return;
}
void h_abortrepeatoverflows_0opt0_retain(const h_abortrepeatoverflows_0opt0 *v) {
...
uint64_t h_abortrepeatoverflows_0opt0_hash(const void *elem) {
    const h_abortrepeatoverflows_0opt0 *v = elem;
...
uint64_t h_abortrepeatoverflows_0opt1_hash(const void *elem) {
    const h_abortrepeatoverflows_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
