/* Generated by heroes 0.2.0 from tests/golden/run/lease-c-keeps-the-pointer.hero. Do not edit. */
...
_Static_assert(HERO_RET_UNIT(stash_put(0)), "heroes-ffi-return stash_put ()");
_Static_assert(HERO_RET_U64(stash_len()), "heroes-ffi-return stash_len u64");
