/* Generated by heroes 0.2.0 from tests/golden/run/abort-handle-borrows-that-gives-away.hero. Do not edit. */
...
#line 50 "aborthandleborrowsthatgivesaway.c"
...
#line 20 "tests/golden/run/abort-handle-borrows-that-gives-away.hero"
__attribute__((unused)) static void hero_ffi_probe_h_aborthandleborrowsthatgivesaway_slot_open(int64_t a0) { (void)(slot_open)(a0); }
#line 21 "tests/golden/run/abort-handle-borrows-that-gives-away.hero"
__attribute__((unused)) static void hero_ffi_probe_h_aborthandleborrowsthatgivesaway_slot_close(Slot * a0) { (void)(slot_close)(a0); }
#line 22 "tests/golden/run/abort-handle-borrows-that-gives-away.hero"
__attribute__((unused)) static void hero_ffi_probe_h_aborthandleborrowsthatgivesaway_slot_value(Slot * a0) { (void)(slot_value)(a0); }
...
#line 89 "aborthandleborrowsthatgivesaway.c"
...
void h_aborthandleborrowsthatgivesaway_main(void) {
#line 107 "aborthandleborrowsthatgivesaway.c"
    Slot * h0_a;
    int64_t t1;
    Slot * t2;
    Slot * t3;
...
int main(int argc, char **argv) {
    ...
    h_aborthandleborrowsthatgivesaway_main();
