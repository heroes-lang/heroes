...
HERO_TU_LOCAL uint64_t h_records_Point_hash(const void *elem);
HERO_TU_LOCAL bool h_records_Pair_eq(const h_records_Pair *a, const h_records_Pair *b);
HERO_TU_LOCAL uint64_t h_records_Pair_hash(const void *elem);
