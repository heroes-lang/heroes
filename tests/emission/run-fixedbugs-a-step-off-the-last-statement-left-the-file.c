...
#line 53 "fixedbugsastepoffthelaststatementleftthefile.c"
...
int64_t h_fixedbugsastepoffthelaststatementleftthefile_twice(int64_t h0_n) {
#line 89 "fixedbugsastepoffthelaststatementleftthefile.c"
    int64_t h1_doubled;
    int64_t t1;
    int64_t t2;
    int64_t t3;
...
#line 27 "tests/golden/run/fixedbugs-a-step-off-the-last-statement-left-the-file.hero"
    return t4;
#line 109 "fixedbugsastepoffthelaststatementleftthefile.c"
}

#line 29 "tests/golden/run/fixedbugs-a-step-off-the-last-statement-left-the-file.hero"
HeroStr h_fixedbugsastepoffthelaststatementleftthefile_shout(HeroStr h0_s) {
#line 114 "fixedbugsastepoffthelaststatementleftthefile.c"
    HeroStr h1_loud = {0};
    HeroStr h2_own2 = {0};
    HeroStr t1 = {0};
    HeroStr t2 = {0};
...
#line 31 "tests/golden/run/fixedbugs-a-step-off-the-last-statement-left-the-file.hero"
    t8 = h2_own2;
#line 157 "fixedbugsastepoffthelaststatementleftthefile.c"
    hero_str_decref(t8);
    return t4;
}
...
#line 38 "tests/golden/run/fixedbugs-a-step-off-the-last-statement-left-the-file.hero"
    h2_own2 = t21;
#line 261 "fixedbugsastepoffthelaststatementleftthefile.c"
    hero_str_decref(t24);
#line 38 "tests/golden/run/fixedbugs-a-step-off-the-last-statement-left-the-file.hero"
    hero_print_str(t21);
#line 38 "tests/golden/run/fixedbugs-a-step-off-the-last-statement-left-the-file.hero"
