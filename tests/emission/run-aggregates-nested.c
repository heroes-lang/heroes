...
typedef struct h_aggregatesnested_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_aggregatesnested_0opt0;

typedef struct h_aggregatesnested_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_aggregatesnested_0opt1;
...
void h_aggregatesnested_0opt0_retain(const h_aggregatesnested_0opt0 *v);
void h_aggregatesnested_0opt0_release(h_aggregatesnested_0opt0 *v);
bool h_aggregatesnested_0opt0_eq(const h_aggregatesnested_0opt0 *a, const h_aggregatesnested_0opt0 *b);
uint64_t h_aggregatesnested_0opt0_hash(const void *elem);
void h_aggregatesnested_0opt1_retain(const h_aggregatesnested_0opt1 *v);
void h_aggregatesnested_0opt1_release(h_aggregatesnested_0opt1 *v);
bool h_aggregatesnested_0opt1_eq(const h_aggregatesnested_0opt1 *a, const h_aggregatesnested_0opt1 *b);
uint64_t h_aggregatesnested_0opt1_hash(const void *elem);
...
#line 31 "tests/golden/run/aggregates-nested.hero"
    t21 = h1_s0;
#line 178 "aggregatesnested.c"
    h_aggregatesnested_Node_retain(&t1);
#line 31 "tests/golden/run/aggregates-nested.hero"
    h1_s0 = t1;
#line 182 "aggregatesnested.c"
...
#line 31 "tests/golden/run/aggregates-nested.hero"
    t20 = h2_r0;
#line 202 "aggregatesnested.c"
    hero_str_incref(t20);
#line 31 "tests/golden/run/aggregates-nested.hero"
    t28 = h1_s0;
#line 206 "aggregatesnested.c"
    h_aggregatesnested_Node_release(&t28);
#line 31 "tests/golden/run/aggregates-nested.hero"
    t29 = h2_r0;
#line 210 "aggregatesnested.c"
    hero_str_decref(t29);
#line 31 "tests/golden/run/aggregates-nested.hero"
    t30 = h3_l;
#line 214 "aggregatesnested.c"
    h_aggregatesnested_Node_c_leaf_release(&t30);
#line 31 "tests/golden/run/aggregates-nested.hero"
    t31 = h4_p;
#line 218 "aggregatesnested.c"
...
#line 39 "tests/golden/run/aggregates-nested.hero"
    h2_own2 = t3;
#line 439 "aggregatesnested.c"
    hero_str_decref(t25);
#line 39 "tests/golden/run/aggregates-nested.hero"
#line 442 "aggregatesnested.c"
    hero_str_incref(t3);
#line 39 "tests/golden/run/aggregates-nested.hero"
...
#line 39 "tests/golden/run/aggregates-nested.hero"
    h5_own5 = t8;
#line 473 "aggregatesnested.c"
    h_aggregatesnested_Name_release(&t28);
#line 39 "tests/golden/run/aggregates-nested.hero"
#line 476 "aggregatesnested.c"
...
#line 46 "tests/golden/run/aggregates-nested.hero"
    t43 = h7_own7;
#line 613 "aggregatesnested.c"
    hero_str_decref(t43);
#line 46 "tests/golden/run/aggregates-nested.hero"
    t44 = h8_own8;
#line 617 "aggregatesnested.c"
    h_aggregatesnested_Holder_release(&t44);
#line 46 "tests/golden/run/aggregates-nested.hero"
    t45 = h9_own9;
#line 621 "aggregatesnested.c"
    hero_str_decref(t45);
#line 46 "tests/golden/run/aggregates-nested.hero"
    t46 = h10_own10;
#line 625 "aggregatesnested.c"
...
uint64_t h_aggregatesnested_0opt0_hash(const void *elem) {
    const h_aggregatesnested_0opt0 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
...
uint64_t h_aggregatesnested_0opt1_hash(const void *elem) {
    const h_aggregatesnested_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
