/* Generated by heroes 0.0.1 from tests/golden/run/adversarial-division-edges.hero. Do not edit. */
...
#line 49 "adversarialdivisionedges.c"

typedef struct h_adversarialdivisionedges_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_adversarialdivisionedges_0opt0;

typedef struct h_adversarialdivisionedges_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_adversarialdivisionedges_0opt1;

void h_adversarialdivisionedges_0opt0_retain(const h_adversarialdivisionedges_0opt0 *v);
void h_adversarialdivisionedges_0opt0_release(h_adversarialdivisionedges_0opt0 *v);
bool h_adversarialdivisionedges_0opt0_eq(const h_adversarialdivisionedges_0opt0 *a, const h_adversarialdivisionedges_0opt0 *b);
uint64_t h_adversarialdivisionedges_0opt0_hash(const void *elem);
void h_adversarialdivisionedges_0opt1_retain(const h_adversarialdivisionedges_0opt1 *v);
void h_adversarialdivisionedges_0opt1_release(h_adversarialdivisionedges_0opt1 *v);
bool h_adversarialdivisionedges_0opt1_eq(const h_adversarialdivisionedges_0opt1 *a, const h_adversarialdivisionedges_0opt1 *b);
uint64_t h_adversarialdivisionedges_0opt1_hash(const void *elem);

void h_adversarialdivisionedges_main(void);

#line 13 "tests/golden/run/adversarial-division-edges.hero"
void h_adversarialdivisionedges_main(void) {
#line 79 "adversarialdivisionedges.c"
    int64_t h0_low;
    int64_t h1_minus;
    int64_t t1;
    int64_t t2;
...
#line 14 "tests/golden/run/adversarial-division-edges.hero"
    h0_low = t3;
#line 15 "tests/golden/run/adversarial-division-edges.hero"
    t4 = h0_low;
#line 15 "tests/golden/run/adversarial-division-edges.hero"
    t5 = INT64_C(1);
#line 15 "tests/golden/run/adversarial-division-edges.hero"
...
#line 15 "tests/golden/run/adversarial-division-edges.hero"
    h0_low = t6;
#line 16 "tests/golden/run/adversarial-division-edges.hero"
    t7 = INT64_C(0);
#line 16 "tests/golden/run/adversarial-division-edges.hero"
    t8 = INT64_C(1);
#line 16 "tests/golden/run/adversarial-division-edges.hero"
...
#line 17 "tests/golden/run/adversarial-division-edges.hero"
    return;
#line 136 "adversarialdivisionedges.c"
}
void h_adversarialdivisionedges_0opt0_retain(const h_adversarialdivisionedges_0opt0 *v) {
    if (v->tag == INT64_C(0)) {
...
uint64_t h_adversarialdivisionedges_0opt0_hash(const void *elem) {
    const h_adversarialdivisionedges_0opt0 *v = elem;
...
uint64_t h_adversarialdivisionedges_0opt1_hash(const void *elem) {
    const h_adversarialdivisionedges_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
...
int main(int argc, char **argv) {
    ...
    h_adversarialdivisionedges_main();
