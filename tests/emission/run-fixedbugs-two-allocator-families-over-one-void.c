/* Generated by heroes 0.2.0 from tests/golden/run/fixedbugs-two-allocator-families-over-one-void.hero. Do not edit. */
...
_Static_assert(HERO_RET_RECORD(arena_new(), void *), "heroes-ffi-return arena_new Arena");
_Static_assert(HERO_RET_UNIT(arena_free((void *){0})), "heroes-ffi-return arena_free ()");
_Static_assert(HERO_RET_RECORD(heap_new(), void *), "heroes-ffi-return heap_new Heap");
_Static_assert(HERO_RET_UNIT(heap_free((void *){0})), "heroes-ffi-return heap_free ()");
...
#line 51 "fixedbugstwoallocatorfamiliesoveronevoid.c"
...
#line 35 "tests/golden/run/fixedbugs-two-allocator-families-over-one-void.hero"
__attribute__((unused)) static void hero_ffi_probe_h_fixedbugstwoallocatorfamiliesoveronevoid_arena_free(void * a0) { (void)(arena_free)(a0); }
#line 37 "tests/golden/run/fixedbugs-two-allocator-families-over-one-void.hero"
...
#line 88 "fixedbugstwoallocatorfamiliesoveronevoid.c"
...
void h_fixedbugstwoallocatorfamiliesoveronevoid_main(void) {
#line 108 "fixedbugstwoallocatorfamiliesoveronevoid.c"
    void * h0_a;
    void * h1_h;
    void * t1;
    void * t2;
...
int main(int argc, char **argv) {
    ...
    h_fixedbugstwoallocatorfamiliesoveronevoid_main();
