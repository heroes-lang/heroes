/* Generated by heroes 0.2.0 from tests/golden/run/a-panic-with-a-live-lease-says-one-thing.hero. Do not edit. */
...
_Static_assert(HERO_RET_UNIT(look(0)), "heroes-ffi-return look ()");
...
int main(int argc, char **argv) {
    ...
    h_apanicwithaliveleasesaysonething_main();
