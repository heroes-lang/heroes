/* Generated by heroes 0.1.0 from tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero. Do not edit. */
...
#line 45 "fixedbugsafloatwithadigitseparator.c"
...
#line 78 "fixedbugsafloatwithadigitseparator.c"
...
void h_fixedbugsafloatwithadigitseparator_main(void) {
#line 94 "fixedbugsafloatwithadigitseparator.c"
    double h0_left;
    double h1_right;
    double h2_both;
    double h3_plain;
...
#line 38 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    return;
#line 164 "fixedbugsafloatwithadigitseparator.c"
}
HERO_TU_LOCAL void h_0opt_f87774a_retain(const h_0opt_f87774a *v) {
    if (v->tag == INT64_C(0)) {
