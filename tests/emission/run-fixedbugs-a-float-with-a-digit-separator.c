/* Generated by heroes 0.0.1 from tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero. Do not edit. */
...
#line 41 "fixedbugsafloatwithadigitseparator.c"
...
#line 59 "fixedbugsafloatwithadigitseparator.c"
#pragma clang diagnostic pop

typedef struct h_fixedbugsafloatwithadigitseparator_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
    } as;
} h_fixedbugsafloatwithadigitseparator_0opt0;

typedef struct h_fixedbugsafloatwithadigitseparator_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
} h_fixedbugsafloatwithadigitseparator_0opt1;

void h_fixedbugsafloatwithadigitseparator_0opt0_retain(const h_fixedbugsafloatwithadigitseparator_0opt0 *v);
void h_fixedbugsafloatwithadigitseparator_0opt0_release(h_fixedbugsafloatwithadigitseparator_0opt0 *v);
bool h_fixedbugsafloatwithadigitseparator_0opt0_eq(const h_fixedbugsafloatwithadigitseparator_0opt0 *a, const h_fixedbugsafloatwithadigitseparator_0opt0 *b);
uint64_t h_fixedbugsafloatwithadigitseparator_0opt0_hash(const void *elem);
void h_fixedbugsafloatwithadigitseparator_0opt1_retain(const h_fixedbugsafloatwithadigitseparator_0opt1 *v);
void h_fixedbugsafloatwithadigitseparator_0opt1_release(h_fixedbugsafloatwithadigitseparator_0opt1 *v);
bool h_fixedbugsafloatwithadigitseparator_0opt1_eq(const h_fixedbugsafloatwithadigitseparator_0opt1 *a, const h_fixedbugsafloatwithadigitseparator_0opt1 *b);
uint64_t h_fixedbugsafloatwithadigitseparator_0opt1_hash(const void *elem);
...
void h_fixedbugsafloatwithadigitseparator_main(void) {
#line 90 "fixedbugsafloatwithadigitseparator.c"
    double h0_left;
    double h1_right;
    double h2_both;
    double h3_plain;
...
#line 30 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    h0_left = t1;
#line 31 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t2 = 0x1.8cccccccccccdp+0;
#line 31 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    h1_right = t2;
#line 32 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t3 = 0x1.f4000346dc5d6p+9;
#line 32 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    h2_both = t3;
#line 33 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t4 = 0x1.5p+3;
#line 33 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    h3_plain = t4;
#line 34 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t5 = h0_left;
#line 34 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_f64(t5);
#line 34 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_end();
#line 35 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t6 = h1_right;
#line 35 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_f64(t6);
#line 35 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_end();
#line 36 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t7 = h2_both;
#line 36 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_f64(t7);
#line 36 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_end();
#line 37 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    t8 = h3_plain;
#line 37 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    hero_print_f64(t8);
#line 37 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
...
#line 38 "tests/golden/run/fixedbugs-a-float-with-a-digit-separator.hero"
    return;
#line 160 "fixedbugsafloatwithadigitseparator.c"
}
void h_fixedbugsafloatwithadigitseparator_0opt0_retain(const h_fixedbugsafloatwithadigitseparator_0opt0 *v) {
    if (v->tag == INT64_C(0)) {
...
uint64_t h_fixedbugsafloatwithadigitseparator_0opt0_hash(const void *elem) {
    const h_fixedbugsafloatwithadigitseparator_0opt0 *v = elem;
...
uint64_t h_fixedbugsafloatwithadigitseparator_0opt1_hash(const void *elem) {
    const h_fixedbugsafloatwithadigitseparator_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
...
int main(int argc, char **argv) {
    ...
    h_fixedbugsafloatwithadigitseparator_main();
