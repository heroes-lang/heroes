/* Generated by heroes 0.2.0 from tests/golden/run/fixedbugs-a-c-function-crosses-as-a-callback.hero. Do not edit. */
...
_Static_assert(HERO_RET_PTR(blob_make()), "heroes-ffi-return blob_make ptr");
_Static_assert(HERO_RET_UNIT(blob_take((void *)0, (int64_t)0, (void *)0)), "heroes-ffi-return blob_take ()");
_Static_assert(HERO_RET_UNIT(counting_free((void *)0)), "heroes-ffi-return counting_free ()");
_Static_assert(HERO_RET_INT(blob_first()), "heroes-ffi-return blob_first i64");
_Static_assert(HERO_RET_INT(blob_frees()), "heroes-ffi-return blob_frees i64");
...
#line 51 "fixedbugsacfunctioncrossesasacallback.c"
...
int main(int argc, char **argv) {
    ...
    h_fixedbugsacfunctioncrossesasacallback_main();
