/* Generated by heroes 0.2.0 from tests/golden/run/c-frees-a-lease-on-a-later-call.hero. Do not edit. */
...
_Static_assert(HERO_RET_UNIT(stash(0)), "heroes-ffi-return stash ()");
_Static_assert(HERO_RET_UNIT(later_free()), "heroes-ffi-return later_free ()");
...
#line 50 "cfreesaleaseonalatercall.c"
...
#line 8 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
__attribute__((unused)) static void hero_ffi_probe_h_cfreesaleaseonalatercall_stash(const char * a0) { (void)(stash)(a0); }
...
#line 85 "cfreesaleaseonalatercall.c"
...
#line 13 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    h1_c = t3;
#line 14 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    t4 = h1_c;
#line 14 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    (void)stash(hero_cstr_nonnull(t4));
#line 15 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    t5 = INT64_C(3);
#line 15 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    hero_print_int(t5);
#line 15 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    hero_print_end();
#line 16 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    (void)later_free();
#line 17 "tests/golden/run/c-frees-a-lease-on-a-later-call.hero"
    hero_held_release(&h1_c);
#line 142 "cfreesaleaseonalatercall.c"
...
int main(int argc, char **argv) {
    ...
    h_cfreesaleaseonalatercall_main();
