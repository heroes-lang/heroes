/* Generated by heroes 0.0.1 from tests/golden/run/functions.hero. Do not edit. */
...
typedef struct h_functions_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
...
void h_functions_0opt0_release(h_functions_0opt0 *v);
bool h_functions_0opt0_eq(const h_functions_0opt0 *a, const h_functions_0opt0 *b);
uint64_t h_functions_0opt0_hash(const void *elem);
void h_functions_0opt1_retain(const h_functions_0opt1 *v);
void h_functions_0opt1_release(h_functions_0opt1 *v);
bool h_functions_0opt1_eq(const h_functions_0opt1 *a, const h_functions_0opt1 *b);
uint64_t h_functions_0opt1_hash(const void *elem);
...
#line 8 "tests/golden/run/functions.hero"
    goto bb1;
#line 117 "functions.c"
}

#line 11 "tests/golden/run/functions.hero"
bool h_functions_is_odd(int64_t h0_n) {
#line 122 "functions.c"
    int64_t t1;
    int64_t t2;
    bool t3;
    bool t4;
...
#line 13 "tests/golden/run/functions.hero"
    goto bb1;
#line 163 "functions.c"
}

#line 16 "tests/golden/run/functions.hero"
void h_functions_main(void) {
#line 168 "functions.c"
    int64_t t1;
    bool t2;
    int64_t t3;
    bool t4;
...
uint64_t h_functions_0opt0_hash(const void *elem) {
    const h_functions_0opt0 *v = elem;
...
uint64_t h_functions_0opt1_hash(const void *elem) {
    const h_functions_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
