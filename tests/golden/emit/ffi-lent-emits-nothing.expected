/* Generated by heroes 0.2.0 from tests/golden/emit/ffi-lent-emits-nothing.hero. Do not edit. */
...
#line 12 "tests/golden/emit/ffi-lent-emits-nothing.hero"
__attribute__((unused)) static void hero_ffi_probe_h_ffilentemitsnothing_strlen(const char * a0) { (void)(strlen)(a0); }
...
#line 15 "tests/golden/emit/ffi-lent-emits-nothing.hero"
    t2 = hero_str_cstr(t1);
#line 15 "tests/golden/emit/ffi-lent-emits-nothing.hero"
    t3 = strlen(hero_cstr_nonnull(t2));
#line 15 "tests/golden/emit/ffi-lent-emits-nothing.hero"
    hero_print_uint(t3);
#line 15 "tests/golden/emit/ffi-lent-emits-nothing.hero"
    hero_print_end();
#line 15 "tests/golden/emit/ffi-lent-emits-nothing.hero"
    return;
#line 118 "ffilentemitsnothing.c"
}
HERO_TU_LOCAL void h_0opt_f87774a_retain(const h_0opt_f87774a *v) {
    if (v->tag == INT64_C(0)) {
