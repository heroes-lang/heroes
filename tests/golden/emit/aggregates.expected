...
typedef struct h_aggregates_0opt0 {
    int64_t tag;
    union {
        HeroStr ok;
        HeroFailure err;
...
typedef struct h_aggregates_0opt1 {
    int64_t tag;
    union {
        HeroFailure err;
    } as;
...
void h_aggregates_0opt0_retain(const h_aggregates_0opt0 *v);
void h_aggregates_0opt0_release(h_aggregates_0opt0 *v);
bool h_aggregates_0opt0_eq(const h_aggregates_0opt0 *a, const h_aggregates_0opt0 *b);
uint64_t h_aggregates_0opt0_hash(const void *elem);
void h_aggregates_0opt1_retain(const h_aggregates_0opt1 *v);
void h_aggregates_0opt1_release(h_aggregates_0opt1 *v);
bool h_aggregates_0opt1_eq(const h_aggregates_0opt1 *a, const h_aggregates_0opt1 *b);
uint64_t h_aggregates_0opt1_hash(const void *elem);
...
#line 120 "aggregates.c"
    ...
    h_aggregates_Shape t12 = {0};
    h_aggregates_Shape_c_line t13 = {0};
    goto bb0;
bb0:
...
#line 38 "tests/golden/emit/aggregates.hero"
    t12 = h1_s0;
#line 169 "aggregates.c"
    h_aggregates_Shape_release(&t12);
#line 38 "tests/golden/emit/aggregates.hero"
    t13 = h3_l;
#line 173 "aggregates.c"
...
#line 210 "aggregates.c"
    ...
    h_aggregates_Outer t31 = {0};
    HeroStr t32 = {0};
    h_aggregates_Inner t33 = {0};
    h_aggregates_Outer t34 = {0};
    h_aggregates_Inner t35 = {0};
    h_aggregates_Outer t36 = {0};
    h_aggregates_Shape t37 = {0};
    h_aggregates_Shape t38 = {0};
    goto bb0;
bb0:
...
#line 43 "tests/golden/emit/aggregates.hero"
    h1_own1 = t3;
#line 269 "aggregates.c"
    hero_str_decref(t23);
#line 43 "tests/golden/emit/aggregates.hero"
#line 272 "aggregates.c"
    hero_str_incref(t3);
#line 43 "tests/golden/emit/aggregates.hero"
...
uint64_t h_aggregates_0opt0_hash(const void *elem) {
    const h_aggregates_0opt0 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
...
uint64_t h_aggregates_0opt1_hash(const void *elem) {
    const h_aggregates_0opt1 *v = elem;
    uint64_t h = (UINT64_C(0xcbf29ce484222325) ^ (uint64_t)v->tag)
        * UINT64_C(0x100000001b3);
    if (v->tag != INT64_C(0)) {
        return (h ^ hero_failure_hash(&v->as.err)) * UINT64_C(0x100000001b3);
